...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-s0!ha1^e4td-wo+0deoa9xgu17ncz%+v_a&$)ci3eysi3o0dpa')
...
ROOT_URLCONF = 'Helldivers_2_Database.urls'
...
WSGI_APPLICATION = 'Helldivers_2_Database.wsgi.application'
